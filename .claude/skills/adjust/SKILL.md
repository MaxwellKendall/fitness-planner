---
name: adjust
description: Handle per-week exceptions — injury, schedule conflict, time constraint, or low energy. Edits the affected plans/YYYY-MM-DD.html in place with an alert banner. Never modifies config.yaml.
user-invocable: true
---
